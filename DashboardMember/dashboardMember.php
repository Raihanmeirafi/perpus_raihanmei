...
<img src="../assets/library Book Sale.png" alt="logo" width="50px">
      ...
      <div class="p-3 mb-2 border bg-secondary">
        <tr>
          <th>
      <div class="bg-warning alert alert-success" role="alert">Selamat datang member - <span class="fw-bold text-capitalize"><?php echo $_SESSION['member']['nama']; ?></span> di Dashboard Perpustakaan</div>
      </th>  
    </tr>
